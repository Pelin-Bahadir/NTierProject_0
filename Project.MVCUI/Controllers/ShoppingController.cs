...
namespace Project.MVCUI.Controllers
{
    public class ShoppingController : Controller
    {
        ...
        public ActionResult ShoppingList(int? page,int? categoryID) //nullable int vermemizin sebebi aslında buradaki int'in kacıncı sayfada oldugumuzu temsil edecek olmasıdır...Ancak birisi direkt alısveriş sayfasına ulastıgında hangi sayfada oldugu verisi olamayacagından dolayı bu şekilde de (yani sayfa numarası gonderilmeden de) bu action'in calısabilmesini istiyoruz...
        {
            ...
            //string b = a ?? "Cagrı"; //a null ise b'ye Cagrı degerini at...Ama a'nın degeri null degilse b'ye a'yı at...
            ...
            {
                Products = categoryID == null ? _pRep.GetActives().ToPagedList(page ?? 1, 9) : _pRep.Where(x=>x.CategoryID==categoryID).ToPagedList(page??1,9),
        ...
        //https://localhost:44329/api/Payment/ReceivePayment
        ...
        public ActionResult ConfirmOrder(OrderVM ovm)
        {
            ...
            using(HttpClient client = new HttpClient())
            {
                ...
                catch (Exception ex)
                {
                    ...
                    TempData["baglantiRed"] = "Banka baglatıyı reddetti";
                ...
                if (result)
                {
                    ...
                    MailService.Send(ovm.Order.Email, body: $"Siparişiniz basrıyla alındı {ovm.Order.TotalPrice}");
